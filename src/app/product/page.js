        ...
        <main className="pt-[65px]">
            ...
            <div className="pt-28 flex items-center justify-center gap-3">
                <div className="w-[300px] h-[200px] px-5 border-2 border-neutral-800 rounded-xl flex items-center justify-center">
                    <a href="https://detect.roboflow.com/?model=pohonsawit2&version=7&api_key=2PNqpkPLTX6glZUiAPGu" className="text-decoration-none px-4 py-2 bg-neutral-800 text-white rounded-xl">Get Started</a>
                </div>
